...
has "$UNIT" 'WorkingDirectory=/home/zlx/projects/oss/herdweb' 'production path must be canonical main repo'
has "$UNIT" 'ExecStart=/home/zlx/projects/oss/herdweb/scripts/serve-prod.sh serve --host 127.0.0.1 --port 7681 -- herdr --session default' 'production command contract changed'
