...
has "$UNIT" 'WorkingDirectory=/home/zlx/projects/oss/remobi' 'production path must be canonical main repo'
has "$UNIT" 'ExecStart=/home/zlx/projects/oss/remobi/scripts/serve-prod.sh serve --host 127.0.0.1 --port 7681 -- herdr --session default' 'production command contract changed'
