...
has "$UNIT" 'ExecStart=/home/zlx/.local/share/fnm/aliases/default/bin/pnpm exec tsx cli.ts serve --host 127.0.0.1 --port 7691 --base-path /remobi --config /home/zlx/projects/oss/remobi/.omo/herdweb-debug.config.ts -- herdr session attach herdweb-dev' 'debug command contract changed'
