...
has "$UNIT" 'ExecStart=pnpm exec tsx cli.ts serve --host 127.0.0.1 --port 7691 --base-path /remobi --config /home/zlx/projects/oss/remobi/.omo/remobi-debug.config.ts -- herdr session attach remobi-dev' 'debug command contract changed'
