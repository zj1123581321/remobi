 ...
 * Pixel-art H> on catppuccin mocha base (#1e1e2e).
 * Green H (#a6e3a1), blue chevron (#89b4fa).
...
export const ICON_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
  ...
  <g fill="#a6e3a1">
    ...
    <rect x="220" y="130" width="28" height="28" rx="4"/>
    <rect x="220" y="166" width="28" height="28" rx="4"/>
    <rect x="220" y="202" width="28" height="28" rx="4"/>
    <rect x="220" y="238" width="28" height="28" rx="4"/>
    <rect x="220" y="274" width="28" height="28" rx="4"/>
    <rect x="220" y="310" width="28" height="28" rx="4"/>
